...
import { useChangeInterviewerPassword } from "@/hooks/useChangeInterviewerPassword"
import { useDeleteInterviewerAccount } from "@/hooks/useDeleteInterviewerAccount"
...
export default function SettingsPage() {
  ...
  const { changePassword, loading: isChangingPassword, error: changePasswordError } = useChangeInterviewerPassword()
  const { deleteAccount: deleteInterviewer, loading: isDeletingInterviewer, error: deleteInterviewerError } = useDeleteInterviewerAccount()
  ...
  const handleDeleteAccount = async () => {
   ...
   try {
      ...
      const message = e?.response?.data?.error || deleteInterviewerError || 'Failed to delete account'
      toast.error(message)
    } finally {
      setIsDeleting(false)
    }
